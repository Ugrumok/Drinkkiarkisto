...
if (isset($_POST["done"])) {
    ...
    if ($name == "") {
        ...
        if ($check->num_rows > 0) {
            ...
            $sql = "INSERT INTO drinkki (nimi, juomalaji, valmistusohje, lisannyt_kayttaja, hyvaksytty) VALUES ('$name', '$drinktype', '$ohjeet', " . $_SESSION["kayttaja_id"] . ", 1)";
            if ($yhteys->query($sql) === TRUE) {
                ...
                $viesti = "Drinkki lisätty.";
            } else {
                $viesti = "Lisäys epäonnistui.";
            }
        }
    }
}
...
<div class="container">
    ...
    <form method="post">
        ...
        <input type="submit" name="done" value="Lisää">
    </form>
