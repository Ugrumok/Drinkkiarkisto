...
<div class="container">
    ...
    <?php
    $result = $yhteys->query("SELECT * FROM drinkki WHERE hyvaksytty = 0 ORDER BY nimi");
    if ($result->num_rows == 0) {
        ...
        while ($rivi = $result->fetch_assoc()) {
            ...
            echo "<b>Ohje:</b> " . $rivi["valmistusohje"] . "<br><br>";

            echo "<form method='post'>";
            echo "<input type='hidden' name='resepti_id' value='" . $rivi["drinkki_id"] . "'>";
            echo "<button type='submit' name='hyvaksy'>Hyväksy</button> ";
            echo "<button type='submit' name='hylkaa'>Hylkää</button>";
            echo "</form>";
